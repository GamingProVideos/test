...
Config.ox_inventory = false -- Use Ox Inventory true/false

Config.Blips = true -- show gas station blips true / false

Config.HUD = false -- show hud true / false
Config.KMhorMPh = "mph" -- "kmh" or "mph" if Config.HUD = true
Config.NPC = "s_m_m_autoshop_01"
...
Config.Fuel_Max_Price = 30000 -- Max price of Fuel
...
Config.Levels = {
	...
	},
	{
		...
		Price = 600000,
		Fuel_Capacity = 60000,
		Petrol_Can_Stock = 120,
	},
	{
		Level = 7,
		Price = 700000,
		Fuel_Capacity = 70000,
		Petrol_Can_Stock = 140,
	},
}
...
Config.refuel_speed = 1.5 -- refuel speed
...
--28	
	{
	coords = vec3(4475,-4448,4),
	npc_coord = {coords = vector3(4467,-4458,4), heading = 243.96},
	vehicle_coord = {coords = vector3(4493,-4447,4), heading = 243.08},
	},
}
